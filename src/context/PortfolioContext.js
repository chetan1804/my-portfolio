...
export const PortfolioProvider = ({ children }) => {
  const portfolioData = {
    ...
    personalInfo: {
      ...
      subtitle:
        "Generative AI | Agentic AI | RAG | LLMs | FastAPI | Python | Node.js | Next.js | React",
      experience:
    ...
    projects: [
      {
        ...
        category: "ai",
        tech: ["Python", "FastAPI", "RAG", "LLMs", "OpenAI", "Vector DB"],
        description:
          "Built an enterprise knowledge assistant using retrieval-augmented generation to answer domain-specific queries from product manuals, policies, and internal documentation.",
        features: [
          "Context-aware grounded answers",
          "Semantic retrieval over large knowledge sets",
          "FastAPI service layer with secure API access",
          "LLM response evaluation and prompt tuning",
          "Human-in-the-loop refinement flows",
        ],
        highlight:
          "Bringing LLM reasoning to real enterprise knowledge retrieval",
      },
      {
        ...
        description:
          "Designed an agentic AI workflow for intelligent task decomposition, autonomous retrieval, and structured execution across business operations.",
        features: [
          "Multi-step task planning and execution",
          "Context routing between tools and memory",
          "Workflow state tracking with agent loops",
          "API-backed orchestration service",
          "Reliable output composition for business use cases",
        ],
        highlight:
          "Moves beyond single-prompt AI into coordinated agent behavior",
      },
      {
        title: "AI Analytics Forecasting Pipeline",
        category: "ai",
        tech: [
          "Python",
          "Pandas",
        ...
        description:
          "Developed a data analytics and ML forecasting pipeline to uncover trends, validate quality, and power predictive insights from business datasets.",
        features: [
          "Exploratory data analysis and data cleaning",
          "Feature engineering and model benchmarking",
          "Forecasting for inventory and performance decisions",
          "Insight dashboards for stakeholders",
          "Reusable Python workflow for future AI experiments",
        ],
      },
      {
